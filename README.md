This project allows users to view and manage book data from a database. Users can add books to their library favorites and track their reading progress—both overall and by category.

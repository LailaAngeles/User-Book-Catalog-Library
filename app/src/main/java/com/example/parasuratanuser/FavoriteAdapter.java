...
public class FavoriteAdapter extends RecyclerView.Adapter<FavoriteAdapter.BookViewHolder> {
    ...
    public FavoriteAdapter(List<BookDetails> bookList) {
    ...
    public void onBindViewHolder(@NonNull BookViewHolder holder, int position) {
        ...
        if (book.hasImage()) {
            try {
                ...
                holder.imageView.setImageBitmap(bitmap != null ? bitmap :
        ...
        // On item click, open BookDetailsActivity
        holder.itemView.setOnClickListener(v -> {
            Context context = holder.itemView.getContext();

            // Save image in SharedPreferences (cache)
